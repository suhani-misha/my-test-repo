...
class Headerelementss extends HTMLElement{
    connectedCallback() {
        this.innerHTML = `
   ...
   customElements.define('header-two' , Headerelementss)
...
class Myheaders extends HTMLElement{
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end">
            ...
            <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="assets/images/county/08.png" width="20" alt=""><span class="ms-2">Hindi</span></a>
             ...
             <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="assets/images/county/12.png" width="20" alt=""><span class="ms-2">Chinese</span></a>
            </li>
          </ul>
        </li>
   ...
   customElements.define('my-headerjjjjjjjjjjjjjjjjjjjjjjjjj',Myheaders)
